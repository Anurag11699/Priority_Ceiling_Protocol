...
//     {
//         inorder(t, n->left);
//         fprintf(output_fd,"J{%d,%d} with priority %d", n->job_object->task_number,n->job_object->job_number,n->job_object->current_priority);
//         fflush(output_fd);
//         inorder(t, n->right);
//     }
//     else
...
//     fprintf(output_fd,"YP\n");
//     fflush(output_fd);

//     fprintf(output_fd,"DELETING J{%d,%d}\n",needed_node_ready_queue->job_object->task_number,needed_node_ready_queue->job_object->job_number);
//     fflush(output_fd);
